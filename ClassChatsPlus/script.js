...
function loadComments() {
    fireBaseRef.on('child_added', function(snapshot) {
        ...
        comment = moderateComment(comment);
...
$("#submit-btn").on("click", function() {
    ...
    if (commentValue.length === 0) {
        ...
        commentValue = moderateComment(commentValue);
        fireBaseRef.push({
